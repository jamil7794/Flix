...
class DetailVC2: UIViewController {
    ...
    override func viewDidLoad() {
       ...
       // https://api.themoviedb.org/3/movie/346910/videos?api_key=a07e22bc18f5cb106bfe4cc1f83ad8ed&language=en-US
//        let url = URL(string: "https://api.themoviedb.org/3/movie/\(idB)/videos?api_key=a07e22bc18f5cb106bfe4cc1f83ad8ed&language=en-US")!
...
//                let videos = dataDictionary["results"] as! [[String: Any]] //array of dictionary, whole set
//                self.videos = videos
...
//        
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
     //   let posterPathString = videos["poster_path"] as! String
